...
public class FragmentedMp4Extractor2 implements Extractor {
  ...
  /** Factory for {@link FragmentedMp4Extractor2} instances. */
  public static final ExtractorsFactory FACTORY =
      () -> new Extractor[] {new FragmentedMp4Extractor2()};
   ...
   */
  public FragmentedMp4Extractor2(@Flags int flags) {
   ...
   */
  public FragmentedMp4Extractor2(@Flags int flags, @Nullable TimestampAdjuster timestampAdjuster) {
