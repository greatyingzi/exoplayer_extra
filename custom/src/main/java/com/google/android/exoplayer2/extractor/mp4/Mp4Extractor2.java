...
import static com.google.android.exoplayer2.extractor.mp4.AtomParsers2.parseTraks;
...
public final class Mp4Extractor2 implements Extractor, SeekMap {

  /** Factory for {@link Mp4Extractor2} instances. */
  public static final ExtractorsFactory FACTORY = () -> new Extractor[] {new Mp4Extractor2()};
   ...
   */
  public Mp4Extractor2(@Flags int flags) {
    this.flags = flags;
    parserState =
  ...
  private void processMoovAtom(ContainerAtom moov) throws ParserException {
    ...
    if (meta != null) {
      mdtaMetadata = AtomParsers2.parseMdtaFromMeta(meta);
    }
  ...
  private void maybeSkipRemainingMetaAtomHeaderBytes(ExtractorInput input) throws IOException {
    ...
    AtomParsers2.maybeSkipRemainingMetaAtomHeaderBytes(scratch);
