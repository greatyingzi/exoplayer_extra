 ...
 *
 * <ul>
 *   <li>MP4, including M4A ({@link Mp4Extractor2})
 *   <li>fMP4 ({@link FragmentedMp4Extractor2})
...
public final class CustomExtractorsFactory implements ExtractorsFactory {
    ...
    @FragmentedMp4Extractor2.Flags private int fragmentedMp4Flags;
     ...
     */
    public synchronized CustomExtractorsFactory setConstantBitrateSeekingEnabled(
     ...
     * @return The factory, for convenience.
     */
    public synchronized CustomExtractorsFactory setAdtsExtractorFlags(
     ...
     * @return The factory, for convenience.
     */
    public synchronized CustomExtractorsFactory setAmrExtractorFlags(@AmrExtractor.Flags int flags) {
        this.amrFlags = flags;
        return this;
    }
     ...
     * @return The factory, for convenience.
     */
    public synchronized CustomExtractorsFactory setFlacExtractorFlags(
     ...
     * @return The factory, for convenience.
     */
    public synchronized CustomExtractorsFactory setMp4ExtractorFlags(@Mp4Extractor.Flags int flags) {
        this.mp4Flags = flags;
        return this;
    }
    ...
    public synchronized CustomExtractorsFactory setFragmentedMp4ExtractorFlags(
            @FragmentedMp4Extractor2.Flags int flags) {
     ...
     * @return The factory, for convenience.
     */
    public synchronized CustomExtractorsFactory setTsExtractorTimestampSearchBytes(
    ...
    private void addExtractorsForFileType(@FileTypes.Type int fileType, List<Extractor> extractors) {
        switch (fileType) {
            ...
            case FileTypes.MP3:
                ...
                break;
            case FileTypes.MP4:
                extractors.add(new FragmentedMp4Extractor2(fragmentedMp4Flags));
                extractors.add(new Mp4Extractor2(mp4Flags));
                break;
            case FileTypes.OGG:
